...
public class ReusableMethod extends IntialScrip {
	 ...
	 * */
	public static void enterText(String objXpath, String textValue, String objName) throws IOException{
		if(driver.findElement(By.xpath(objXpath)).isDisplayed()){
			driver.findElement(By.xpath(objXpath)).sendKeys(textValue);
	 ...
	 * Last Modified: Apr 14 2015 
	 * */
	public static void clickObj(String objXpath,String objName) throws IOException{
		if(driver.findElement(By.xpath(objXpath)).isDisplayed()){
	 ...
	 * Last Modified: Apr 15 2015 
	 * */
	public static void deSelectCheckBox(String objXpath,String objName) throws IOException{
		if(driver.findElement(By.xpath(objXpath)).isDisplayed()){
			if(driver.findElement(By.xpath(objXpath)).isSelected()){
				driver.findElement(By.xpath(objXpath)).click();
	...
	public static void validateText(String objXpath, String expectedText, String objName){
		String actualText;
		if(driver.findElement(By.xpath(objXpath)).isDisplayed()){
			actualText = driver.findElement(By.xpath(objXpath)).getText();
